...
const legalTasks = [
    ...
    },
    {
        ...
        description: 'Register for GST if your business turnover exceeds threshold.',
...
function LegalScorePage() {
    ...
    return (
        <div className="flex-grow flex flex-col items-center justify-start text-text p-4 sm:p-6 pt-8 sm:pt-12">
            ...
            >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 gap-2">
                    <span className="text-base sm:text-lg font-medium text-text">Your Legal Score:</span>
                    <span className="text-2xl sm:text-3xl font-bold text-active">{score} / {totalMaxPoints}</span>
                </div>
                        ...
                        <div className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0">
                            ...
                            <div className="flex items-start flex-grow">
                                ...
                                <div className="ml-3 sm:ml-4 flex-grow">
                                    <label htmlFor={task.id} className="text-base sm:text-lg font-semibold text-text cursor-pointer">
                                        {task.name}
                                    </label>
                            ...
                            <div className="flex items-center justify-between sm:justify-end space-x-2 sm:space-x-3 ml-8 sm:ml-0">
                                ...
                                >
                                    {expandedTasks[index] ? <FaChevronUp className="w-4 h-4" /> : <FaChevronDown className="w-4 h-4" />}
                                </button>
                        ...
                        {expandedTasks[index] && (
                            ...
                            >
                                <div className="p-4 sm:p-5">
                                    <h4 className="text-sm sm:text-md font-semibold text-text mb-3">Step-by-Step Guide:</h4>
